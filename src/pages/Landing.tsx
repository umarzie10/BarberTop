  ...
  return (
    <header
      className={`fixed top-0 inset-x-0 z-50 transition-all duration-500 ${
        scrolled ? "py-3 backdrop-blur-xl bg-white/80 border-b border-blue-100" : "py-5 bg-transparent"
      }`}
    >
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-2.5 group">
          ...
          <span className={`font-bold tracking-tight text-lg transition ${scrolled ? "text-blue-900" : "text-white"}`}>
        ...
        <nav className="hidden md:flex items-center gap-8 text-sm text-blue-600 hover:text-blue-700">
           <a href="#barbers" className="hover:text-blue-800 transition">{t("land.menu.barbers")}</a>
           <a href="#trends" className="hover:text-blue-800 transition">{t("land.menu.trends")}</a>
           <a href="#premium" className="hover:text-blue-800 transition">{t("land.menu.premium")}</a>
           <a href="#join" className="hover:text-blue-800 transition">{t("land.menu.join")}</a>
         </nav>

        <div className="hidden md:flex items-center gap-3">
          <div className="flex items-center gap-1 text-xs">
            <Globe className={`w-3.5 h-3.5 ${scrolled ? "text-blue-600" : "text-white"}`} />
            {langs.map((l) => (
              <button
                key={l}
                onClick={() => setLang(l)}
                className={`px-2 py-1 rounded transition ${
                  lang === l 
                    ...
                    : scrolled ? "text-blue-600 hover:text-blue-800" : "text-white hover:text-white/80"
                }`}
        ...
        >
          {[
           ...
           <div className="flex gap-2 pt-2 border-t border-white/10">
             <Link to="/auth/login" className="flex-1 px-4 py-2 text-sm text-center text-blue-600 border border-blue-300 rounded-full bg-white hover:bg-blue-50">{t("auth.login")}</Link>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center w-full">
        ...
        >
           ...
           <motion.div
             ...
             style={{ borderColor: `${GOLD}60`, boxShadow: `0 30px 80px -20px ${GOLD}50` }}
           >
             ...
             <div className="p-4 bg-white/90">
               <div className="flex items-center justify-between mb-1">
                 ...
                 <span className="px-2 py-0.5 text-[10px] rounded-full text-white font-bold" style={{ background: GOLD }}>PRO</span>
               </div>
           ...
           >
             <div className="flex items-center gap-3">
               ...
               <div>
                 ...
                 <p className="text-[11px] text-blue-600">Bugun bron qilindi</p>
               </div>
             </div>
           </motion.div>
           ...
           >
             <div className="flex items-center gap-2 mb-2">
               ...
               <p className="text-xs font-medium text-green-600">Online hozir</p>
             </div>
             <p className="text-sm text-blue-900">42 ta barber qabul qilmoqda</p>
           </motion.div>
        </motion.div>
      </div>
...
const TopBarbers = () => {
  ...
  return (
    <section id="barbers" className="relative py-32 px-6 bg-gradient-to-b from-white via-blue-50 to-blue-100">
             ...
             >
               <div className="relative h-72 overflow-hidden">
                 ...
                 <div className="absolute bottom-3 left-3 flex items-center gap-1 px-2 py-1 rounded-md backdrop-blur-md bg-white/80">
                   ...
                   <span className="text-xs font-semibold text-blue-900">{b.rating}</span>
                 </div>
               </div>
               <div className="p-4">
                 ...
                 <div className="flex items-center justify-between">
                   <span className="text-sm text-blue-700">dan <span className="text-blue-900 font-semibold">{b.price}</span></span>
                   <button
...
const AISection = () => (
   <section className="relative py-32 px-6 overflow-hidden bg-gradient-to-b from-blue-100 to-white">
     ...
     <div className="relative max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
       <motion.div {...fadeUp}>
         <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-medium mb-5 border" style={{ borderColor: `${GOLD}60`, color: GOLD }}>
       ...
       <motion.div {...fadeUp} className="relative">
         <div
           ...
           style={{ borderColor: `${GOLD}50`, background: "rgba(255,255,255,0.7)" }}
         >
           ...
           <div className="space-y-3">
             ...
             <div className="px-4 py-2.5 rounded-2xl rounded-tr-sm text-sm text-white max-w-[75%] ml-auto" style={{ background: GOLD_SOFT }}>
...
const Trends = () => {
   ...
   return (
     <section id="trends" className="py-32 px-6 bg-gradient-to-b from-white via-blue-50 to-white">
       <div className="max-w-7xl mx-auto">
         ...
         <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
           {features.map((f, i) => (
             ...
             >
               ...
               <h3 className="text-lg font-semibold text-blue-900 mb-1.5">{f.title}</h3>
...
const Premium = () => {
   ...
   return (
     <section id="premium" className="py-32 px-6 relative overflow-hidden bg-gradient-to-b from-white to-blue-50">
       <div
         className="absolute inset-0"
         style={{ background: `radial-gradient(ellipse at center, ${GOLD}20 0%, transparent 60%)` }}
       />
       <div className="relative max-w-5xl mx-auto">
         <motion.div
           ...
           style={{
             borderColor: `${GOLD}60`,
             background: "linear-gradient(135deg, rgba(37,99,235,0.1), rgba(255,255,255,0.8))",
         ...
         >
           ...
           <div className="grid sm:grid-cols-2 gap-3 max-w-xl mx-auto mb-10 text-left">
             {benefits.map((b, i) => (
               <div key={i} className="flex items-center gap-2.5 px-4 py-2.5 rounded-xl bg-blue-100/50">
           ...
           <div className="flex items-baseline justify-center gap-2 mb-6">
             ...
             <span className="text-blue-700">so'm/oy</span>
           </div>
       ...
       <div className="max-w-6xl mx-auto">
         ...
         <div className="grid md:grid-cols-3 gap-5">
           {reviews.map((r, i) => (
             ...
             >
               <Quote className="absolute top-5 right-5 w-8 h-8 opacity-30" style={{ color: GOLD }} />
               <div className="flex gap-0.5 mb-4">
                 {[1, 2, 3, 4, 5].map((s) => <Star key={s} className="w-3.5 h-3.5 fill-current" style={{ color: GOLD }} />)}
               </div>
               <p className="text-blue-700 mb-6 leading-relaxed text-sm">{r.text}</p>
               <div className="flex items-center gap-3">
       ...
       <motion.div {...fadeUp}>
         ...
         <div className="flex flex-wrap gap-3">
           {["App Store", "Google Play"].map((s) => (
             <button key={s} className="px-6 py-3 rounded-xl border border-blue-300 bg-white text-blue-600 text-sm hover:bg-blue-50 transition">
               {s}
             </button>
           ))}
         </div>
       ...
       <motion.div {...fadeUp} className="relative flex justify-center">
         ...
         >
           ...
           <div className="absolute bottom-6 inset-x-4 p-4 rounded-2xl backdrop-blur-xl bg-white/80 border border-blue-200">
             <p className="text-xs text-blue-600 mb-1">Keyingi bron</p>
             <p className="text-blue-900 font-semibold mb-2">Davron Karimov</p>
             <div className="flex items-center justify-between text-xs">
               <span className="text-blue-700">Bugun, 18:30</span>
               <span className="px-2 py-0.5 rounded-full text-white font-semibold" style={{ background: GOLD }}>Tasdiqlangan</span>
             </div>
           </div>
         </div>
       </motion.div>
     ...
     <div className="max-w-7xl mx-auto">
       <div className="grid md:grid-cols-4 gap-10 mb-12">
         ...
         {[
           ...
           <div key={i}>
             <p className="font-semibold text-blue-900 text-sm mb-4">{c.title}</p>
             <ul className="space-y-2.5">
               {c.items.map((item) => (
                 <li key={item}>
                   <a href="#" className="text-sm text-blue-600 hover:text-blue-800 transition">{item}</a>
                 </li>
               ))}
             </ul>
           </div>
       ...
       <div className="flex flex-col md:flex-row items-center justify-between pt-8 border-t border-blue-200 gap-4">
         <p className="text-xs text-blue-500">© 2026 BarberTop. Barcha huquqlar himoyalangan.</p>
         <div className="flex items-center gap-3">
...
const Landing = () => {
   return (
     <div className="min-h-screen bg-white text-blue-900">
       <Header />
       <Hero />
       <div className="pt-12 bg-gradient-to-b from-white to-blue-50" /> {/* spacing for floating search bar */}
       <TopBarbers />
       <AISection />
       <Trends />
       <WhyUs />
