    ...
    <div className="p-6 max-w-4xl mx-auto">
      <div className="bg-gradient-to-br from-primary to-primary/70 text-primary-foreground rounded-xl p-8 mb-6">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h1 className="text-2xl font-semibold">{t("client.welcome")}!</h1>
        </div>
        <p className="opacity-90 mb-4">{t("client.dashboardDescription")}</p>
        <button
          onClick={() => navigate("/book")}
          className="bg-background text-foreground px-4 py-2 rounded-md text-sm font-medium hover:opacity-90 forge-transition"
        >
          {t("client.bookBtn")}
        </button>
      </div>
      ...
      <Card>
        ...
        {!appts.length ? (
          <Empty text={t("client.noBookings")} />
        ) : (
