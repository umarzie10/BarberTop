...
const Integrations = () => {
  ...
  const openSettings = (integ: Integration) => {
    ...
    <div className="p-6">
      ...
      <div className="mb-8">
        <h2 className="text-sm font-semibold text-foreground mb-3 flex items-center gap-2">
          ...
          {t("int.connected")} ({connected.length})
        </h2>
      ...
      <div>
        <h2 className="text-sm font-semibold text-foreground mb-3">{t("int.available")} ({available.length})</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
          {available.map((integ) => (
            <motion.div
              key={integ.id}
            ...
            >
              <div className="flex items-start justify-between mb-2">
                ...
                <span className="flex items-center gap-1 text-[10px] font-medium text-primary bg-primary/10 px-2 py-0.5 rounded opacity-0 group-hover:opacity-100 forge-transition">
